...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnBuildHead( oSettings )
		{
			...
			if ( oSettings.oFeatures.bSort )
			{
				for ( i=0 ; i<oSettings.aoColumns.length ; i++ )
				{
					...
					{
                        if(oSettings.aoColumns[i].sType != 'html') {
		...
		function _fnSortingClasses( oSettings )
		{
			...
			for ( i=0 ; i<oSettings.aoColumns.length ; i++ )
			{
				if ( oSettings.aoColumns[i].bSortable )
				{
                    ...
                    if($(oSettings.aoColumns[i].nTh).find('input').length == 0) {
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select class="changePageNum" size="1" '+sName+'>';
			var i, iLen;
			...
			nLength.innerHTML = oSettings.fnTabInnerHtml+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>'+oSettings.fnTabFilter;

			/*
			 * Set the length to the current display length - thanks to Andrea Pavlovic for this fix,
			 * and Stefan Skopnik for fixing the fix!
			 */
			$('select.changePageNum option[value="'+oSettings._iDisplayLength+'"]',nLength).attr("selected",true);

			$('select.changePageNum', nLength).bind( 'change.DT', function(e) {
				var iVal = $(this).val();
		...
		return this.each(function()
		{
			...
			if ( typeof oInit != 'undefined' && oInit !== null )
			{
                ...
                _fnMap( oSettings, oInit, "fnTabInnerHtml" );
                _fnMap( oSettings, oInit, "fnTabFilter" );
