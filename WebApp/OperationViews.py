...
def create_srv_set(project_name):
    ...
    if(request.method == "GET"):
        return render_template("srv_set.html", title = "Create",pname=project_name,pdir = config.SCRIPT_PATH + dirProject, file_list = lstFile, server_list = lstServer)
...
def show_srv_set_list(project_name):
    ...
    return render_template("srv_set_list.html", title = "Server Set List", project_name = project_name, server_set_list = lstServerSet)
